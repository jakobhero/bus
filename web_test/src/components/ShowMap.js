...
function ShowMap({
  ...
  const icoStatusData = (e) => {
    if ((Object.values(test).includes(parseInt(selected.stopid))) ){
      console.log('deleteing')
      delCookie(selected.stopid);
      console.log((Object.values(test).includes(parseInt(selected.stopid))))
    }
    else{
      console.log('adding')
        ...
        {selected ? (
          ...
          >
            <div>
              ...
              <span className={(Object.values(test).includes(parseInt(selected.stopid))) ? "fa fa-star" : "fa fa-star-o"} onClick={(e) => icoStatusData()}></span>
              {console.log(typeof(parseInt(selected.stopid)),Object.values(test) )}
